...
\paragraaf{Maturity}
As mentioned the maturity of a framework is determined based on the presence the predefined of trustworthy elements.
...
The documentation is updated either on the day of a new release or the day after. %TODO bron: http://docs.appcelerator.com/titanium/2.1/index.html
...
\item [Use of Established Mobile Standards] 
%On the surface JavaScript API, Titanium has full support for CommonJS . 
...
\item [Use of code management and versioning tools] Titaniums' code base is mainted in a public github account.%TODO github verklaren account. For 
