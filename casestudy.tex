...
\noindent Below is a simplified list of the feature requirements of the iStager application.\footnote{The complete set of requirements is attached as a appendix II - Preliminary research} %TODO apendix.
\begin{enumerate}
\item
