...
%TODO: eerste persoonsvorm verplaatsen naar 3e persoonsvorm. Is door dit hele hoofdstuk een issue.
...
%iOS was chosen for the native version of the benchmark application. The reason for this being very practical: an

It took three days to complete the benchmark app, from which the majority of the time was spend on parsing data using x-path, which I had never used before.
\begin{figure}%
	\centering
	\parbox{0.0in}
	\qquad
