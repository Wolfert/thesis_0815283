...
One of the issues which came up was that Titanium does not support DOM3 level specifications\cite{Whinnery2011}. This effectively rules out the xpath evaluate function which has support for an xml namespace resolver.\cite{Whitmer}
