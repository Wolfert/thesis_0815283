...
Lunatech has demand for the development of cross-platform mobile applications. Untill today these applications have been developed using webtechnologiesch such as HTML5 and Javascript. A mobile application developed this way is refered to as webapp because it runs in a browserbased environment and is often hosted at a webserver rather than downloaded to the device itself.
